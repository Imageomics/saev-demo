...
This repo is a fork of [saev - Sparse Auto-Encoders for Vision](https://github.com/OSU-NLP-Group/saev) for use in the Imageomics Conference Tooling Workshop. Only minor modifications are made to help with facilitation. Overall functionality remains the same.
